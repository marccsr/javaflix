...
import es.uah.vsnvmgr.javaflix.app.TarjetaCredito;
import es.uah.vsnvmgr.javaflix.app.Usuario;
import java.io.*;
...
public class Registro extends javax.swing.JFrame {
 ...
 /**
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        jTextField2.setText("Nombre");
        jTextField3.setText("Email");
        jTextField4.setText("Num de la tarjeta");
        ...
        for (int i = 0; i<jTextField1.getText().length(); ++i){
            ...
            if (!("abcdefghijklmnñopqrstuvwxyz".contains(Character.toString(dniArray[i]).toLowerCase()))){
                dniCorrecto=false;
            }
            }
        }
        ...
        for (int j=0; j<jTextField2.getText().length();++j){
            if (!("abcdefghijklmnopqrstuvwxyz ".contains((Character.toString(jTextField2.getText().charAt(j))).toLowerCase()))){
        ...
        jLabel2.setText(jLabel2.getText()+"El email no tiene el formato correcto.");
        }
